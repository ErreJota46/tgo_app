...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/savedScreen',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'SavedScreen')
              : const SavedScreenWidget(),
        ),
        FFRoute(
          name: 'SettingsPage',
          path: '/settingsPage',
        ...
        FFRoute(
          ...
          path: '/searchScreen',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'SearchScreen')
              : SearchScreenWidget(
        ...
        FFRoute(
          ...
          path: '/mapsPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'MapsPage')
              : const MapsPageWidget(),
        ),
        FFRoute(
          name: 'ForgottenPassword1',
          path: '/forgottenPassword1',
          builder: (context, params) => const ForgottenPassword1Widget(),
        ),
        FFRoute(
          name: 'PrivacyPolicy',
          path: '/privacyPolicy',
        ...
        FFRoute(
          name: 'ForgottenPassword2',
          path: '/forgottenPassword2',
          builder: (context, params) => const ForgottenPassword2Widget(),
        ),
        FFRoute(
          name: 'Language',
          path: '/language',
        ...
        FFRoute(
          ...
          path: '/homePageResults',
          builder: (context, params) => HomePageResultsWidget(
            search: params.getParam(
              'search',
              ParamType.String,
            ),
