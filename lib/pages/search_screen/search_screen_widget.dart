  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<TouristPlacesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TouristPlacesRow> searchScreenTouristPlacesRowList =
            snapshot.data!;
        final searchScreenTouristPlacesRow =
            searchScreenTouristPlacesRowList.isNotEmpty
                ? searchScreenTouristPlacesRowList.first
                : null;
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 12.0, 0.0, 50.0),
                      child: FutureBuilder<ApiCallResponse>(
                        future: BusquedaCompletaCall.call(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final listViewBusquedaCompletaResponse =
                              snapshot.data!;
                          return Builder(
                            builder: (context) {
                              final userItems = listViewBusquedaCompletaResponse
                                  .jsonBody
                                  .toList()
                                  .take(8)
                                  .toList();
